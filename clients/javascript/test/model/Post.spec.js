...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new @OptimisticninjaPostsApiJsClient.Post();
  });
  ...
  describe('Post', function() {
    it('should create an instance of Post', function() {
      ...
      //var instance = new @OptimisticninjaPostsApiJsClient.Post();
      //expect(instance).to.be.a(@OptimisticninjaPostsApiJsClient.Post);
    });
