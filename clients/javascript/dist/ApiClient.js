...
var ApiClient = /*#__PURE__*/function () {
   ...
   */
  function ApiClient() {
    var basePath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'https://localhost:8443/v1';
    ...
    this.defaultHeaders = {
      'User-Agent': 'OpenAPI-Generator/0.0.1-SNAPSHOT/Javascript'
    };
    /**
      ...
      return [{
        ...
        'variables': {
          ...
          host: {
            ...
            'enum_values': ["localhost", "optimistic.ninja"]
          },
          port: {
            'description': "No description provided",
            'default_value': "8443",
            'enum_values': ["443", "8443"]
          }
        }
      }];
    }
